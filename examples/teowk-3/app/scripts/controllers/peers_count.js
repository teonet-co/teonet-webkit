...
/**
 * @ngdoc function
 * @name teonetWebkitApp.controller:PeersCountCtrl
 * @description
 * # PeersCountCtrl
...
angular.module('teonetWebkitApp')
  ...
  .controller('PeersCountCtrl', function ($scope, teonet) {
    ...
    function eventCb(ke, ev, data) { //, dataLen, userData) {
        ...
        console.log('PeersCountCtrl: Custom event callback called');
        ...
        switch (ev) {
            ...
            case teonet.ev.EV_K_RECEIVED:
                ...
                switch (rd.cmd) {
                    ...
                    case teonet.api.CMD_ECHO_ANSWER:
                        console.log('PeersCountCtrl: Echo answer command event received');
                        break;
            ...
            case teonet.ev.EV_A_INTERVAL:
                ...
                console.log('PeersCountCtrl: Interval event received');
                break;
    ...
    teonet.processing($scope, eventCb, 1000, function() {
        console.log('PeersCountCtrl: Start processing teonet controller');
    });
